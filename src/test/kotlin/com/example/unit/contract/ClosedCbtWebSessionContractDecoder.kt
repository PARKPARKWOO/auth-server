...
fun bindAuthCookieProperties(profileResource: String? = null): AuthCookieProperties =
    bindYamlConfig("auth.cookie", AuthCookieProperties::class.java, profileResource)
