...
class CbtWebCookieSessionContractFixtureTest {
    ...
    @Test
    fun `web cookie session fixture freezes the exact cookie csrf and operation contract`() {
        val stream = assertNotNull(javaClass.classLoader.getResourceAsStream("contracts/cbt-web-cookie-session.json"))
